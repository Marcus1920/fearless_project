$(document).ready(function(){
    ...
    (function(){
        $('body').on('click touchstart', '.drawer-toggle', function(e){
            ...
            if ( location.indexOf('public') >= 0 ) {

                location = "http://41.216.130.6:8080/siyaleader-dut/public/getOfflineMessage";

            } else {

                location = "/getOfflineMessage";
    ...
    $(function() {
        $('body').on('click touchstart', '.chat-list-toggle', function(){
            ...
            if ( location.indexOf('public') >= 0 ) {
                ...
                location = "http://41.216.130.6:8080/siyaleader-dut/public/getLoggedInUsers";
