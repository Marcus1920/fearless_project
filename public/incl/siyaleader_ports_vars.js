...
var map;
var SA,DBN,RB,EL,NG,PE,MOS,CT,SAL;
if (typeof google != "undefined") {
	SA = new google.maps.LatLng(-30.326385, 24.188828);
	DBN = new google.maps.LatLng(-29.881651, 30.989003);
	RB = new google.maps.LatLng(-28.807896, 32.041361);
	EL = new google.maps.LatLng(-33.025901, 27.883711);
	NG = new google.maps.LatLng(-33.766334, 25.667147);
	PE = new google.maps.LatLng(-33.960700, 25.618584);
	MOS = new google.maps.LatLng(-34.178028, 22.140478);
	CT = new google.maps.LatLng(-33.910667, 18.440199);
	SAL = new google.maps.LatLng(-33.048716, 18.005201);
}
...
var dbnEightMilePollyCoords = null;
if (typeof google != "undefined") dbnEightMilePollyCoords = [
