...
<div class="block-area" id="basic">
    ...
    <div class="tile p-15">
        {!! Form::open(['url' => 'users', 'method' => 'post', 'class' => 'form-horizontal', 'id'=>"registrationForm" ]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-icon datetime-pick date-only">
                        {!! Form::text('dob',NULL,['class' => 'form-control input-sm','id' => 'name']) !!}
            ...
            <div class="form-group">
                {!! Form::label('Work Place Position', 'Work Place Position', array('class' => 'col-md-2 control-label')) !!}
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {!! Form::select('port',$selectPorts,0,['class' => 'form-control input-sm' ,'id' => 'port']) !!}
                    @if ($errors->has('port')) <p class="help-block red">*{{ $errors->first('port') }}</p> @endif
                </div>
            </div>
