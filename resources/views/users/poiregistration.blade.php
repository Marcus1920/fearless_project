...
function generate_vehicle_html(val) {
    ...
    if (val == 2) {
        ...
        generate_vehicle_html += '{!! Form::label("Driver Licence Code", "Driver Licence Code") !!}';
        generate_vehicle_html += "<input name='drivers_licence[]' type='text' class='form-control input-sm m-b-10'/>";
        generate_vehicle_html += "</div>";
        generate_vehicle_html += "<div class='col-md-4 driverlicencenumber'>";
        generate_vehicle_html += '{!! Form::label("Date Issued", "Date Issued") !!}';
        generate_vehicle_html += '<div class="input-icon datetime-pick date-only">';
        generate_vehicle_html += '<input data-format="yyyy-MM-dd" type="text" name="drivers_licence_date_issued[]" class="form-control input-sm m-b-10" />';
        generate_vehicle_html += '<span class="add-on">';
        generate_vehicle_html += '<i class="sa-plus"></i>';
        generate_vehicle_html += '</span>';
        generate_vehicle_html += '</div>';
        generate_vehicle_html += "</div>";

        generate_vehicle_html += "<div class='col-md-4 driverlicencenumber'>";
        generate_vehicle_html += '{!! Form::label("Expiry Date", "Expiry Date") !!}';
        generate_vehicle_html += '<div class="input-icon datetime-pick date-only">';
        generate_vehicle_html += '<input data-format="yyyy-MM-dd" type="text" name="drivers_licence_expiry_date[]" class="form-control input-sm m-b-10" />';
        generate_vehicle_html += '<span class="add-on">';
        generate_vehicle_html += '<i class="sa-plus"></i>';
        generate_vehicle_html += '</span>';
        generate_vehicle_html += '</div>';
