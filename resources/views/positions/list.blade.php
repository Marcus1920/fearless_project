...
<ol class="breadcrumb hidden-xs">
    ...
    <li class="active">Work Place Positions Listing</li>
</ol>

<h4 class="page-title">WORK PLACE POSITIONS</h4>
<!-- Alternative -->
<div class="block-area" id="alternative-buttons">
    <h3 class="block-title">Work Place Positions Listing</h3>
    <a class="btn btn-sm" data-toggle="modal" onClick="launchAddPositionModal();" data-target=".modalAddPosition">
     Add Work Place Position
    </a>
</div>
