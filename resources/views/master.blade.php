...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-blur-ocean">
            ...
            <aside id="sidebar">
                ...
                <div class="side-widgets overflow" style="position: relative;">
                    ...
                    <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
                        <a href="" data-toggle="dropdown">
                            ...
                            <img class="profile-pic animated" src="{{ asset('/images/site_badge.png') }}" alt="">
                ...
                @if(isset($userViewCalendarPermission) && $userViewCalendarPermission->permission_id =='13')
                    <li {{ (Request::is('map') ? "class=active" : '') }}>
                        <a class="sa-side-map" href="{{ url('map') }}">
                ...
                @if(isset($userViewCalendarPermission) && $userViewCalendarPermission->permission_id =='13')
                    <li {{ (Request::is('calendar') ? "class=active" : '') }}>
                        <a class="sa-side-calendar" href="{{ url('calendarreal') }}">
                ...
                @if(isset($userViewCasesPermission) && $userViewCasesPermission->permission_id =='15')
                    <li {{ (Request::is('home') ? "class=active" : '') }}>
                        ...
                        <ul class="list-unstyled menu-item" style="top: 120px;">
                            <li><a href="{{ url('list-pending-cases') }}"><span class="badge badge-r">{{ $nums['cases_pending'] }}</span>Pending Cases</a></li>
                            <li><a href="{{ url('list-pending-closure-cases') }}"><span class="badge badge-r">{{ $nums['cases_pending_closure'] }}</span>Pending Closure Cases</a></li>
                            <li><a href="{{ url('list-allocated-cases') }}"><span class="badge badge-r">{{ $nums['cases_allocated'] }}</span>Allocated/Referred Cases</a></li>
                            <li><a href="{{ url('list-closed-cases') }}"><span class="badge badge-r">{{ $nums['cases_closed'] }}</span>Closed Cases</a></li>
                        </ul>
                    </li>
                @endif
                @if(isset($userViewAdministrationPermission) && $userViewAdministrationPermission->permission_id =='14')
                    ...
                    <li {{ (Request::is('list-users') ? "class=active dropdown" : 'dropdown') }}>
                        ...
                        <ul class="list-unstyled menu-item">
                           ...
                           <!-- @if(isset($userViewCaseStatusPermission) && $userViewCaseStatusPermission->permission_id =='3')
                            ...
                            <li><a href="{{ url('list-positions') }}"><span class="badge badge-r">{{ count($noPositions,0) }}</span>Workplace Positions</a></li>


                            @endif--}}
                                @if(isset($userViewPositionsPermission) && $userViewPositionsPermission->permission_id =='6')

                                    <li><a href="{{ url('list-positions') }}"><span class="badge badge-r">{{ count($noPositions,0) }}</span>Work Place Positions</a></li>

                                @endif

                            @if(isset($userViewProvincesPermission) && $userViewProvincesPermission->permission_id =='7')

                            <li><a href="{{ url('list-ports') }}"><span class="badge badge-r">{{ count($noProvinces,0) }}</span>Ports</a></li>
                            @endif
                                {{--@if(isset($userViewProvincesPermission) && $userViewProvincesPermission->permission_id =='7')--}}

                                    {{--<li><a href="{{ url('list-provinces') }}"><span class="badge badge-r">{{ count($noProvinces,0) }}</span>Ports</a></li>--}}
                                {{--@endif--}}
                  ...
                  @if(isset($userViewReportsPermission) && $userViewReportsPermission->permission_id =='16')
                   ...
                   @endif
                    ...
                    <li {{ (Request::is('reports') ? "class=active" : '') }}>
                        <a class="sa-side-truck" href="{{ url('list-trucks-companies') }}">
                            <span class="menu-item">Trucks</span>
                        </a>
                    </li>
                   @endif
				   ...
				   @if(isset($userViewReportsPermission) && $userViewReportsPermission->permission_id =='16')
                    ...
                    <li {{ (Request::is('reports') ? "class=active" : '') }}>
                        <a class="sa-side-gate" href="{{ url('list-gate-track-entries') }}">
                            <span class="menu-item">Gate Track Entries</span>
                        </a>
                    </li>
                   @endif
                    ...
                    <li {{ (Request::is('Meetings') ? "class=active" : '') }}>
                            <a class="sa-side-meetings" href="{{ url('list-meetings') }}">
		...
		<!--Time Entry-->
		<script src="{{ asset('/js/TimeEntry/jquery.plugin.js') }}"></script> 
        <script src="{{ asset('/js/TimeEntry/jquery.timeentry.js') }}"></script> 
		<!--End Time Entry-->
		...
		<script type="text/javascript" src="{{ asset('/js/lib/site.js') }}"></script>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                var url =  'lcases-calendar-list-perUser';

                $('#landings_calendar').fullCalendar({
                        header: {
                         center: 'title',
                         left: 'prev, next',
                         right: ''
