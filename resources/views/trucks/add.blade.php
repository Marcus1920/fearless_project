<!-- Modal Default -->
<div class="modal fade modalAddTruck" id="modalAddTruck" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => 'addTruck', 'method' => 'post', 'class' => 'form-horizontal', 'id'=>"updateCategoryForm" ]) !!}
            {!! Form::hidden('companyID',$truckCompObj->id) !!}
            ...
            <div class="form-group">
                <div class="col-md-offset-4 col-md-10">
                    <button type="submit" id='submitUpdateCategoryForm' type="button" class="btn btn-sm">Add Truck</button>
                </div>
            </div>
            </div>
