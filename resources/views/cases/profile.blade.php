                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="tile">
                            ...
                            <div class="form-group">
                                {!! Form::label('Client Name', 'Refered To', array('class' => 'col-md-3 control-label')) !!}
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                {!! Form::label('Client Cellphone', 'Cellphone', array('class' => 'col-md-3 control-label')) !!}
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                {!! Form::label('Client Cellphone', 'Due Date', array('class' => 'col-md-3 control-label')) !!}
                                <div class="col-md-6">
                                    {!! Form::text('householdCell',NULL,['class' => 'form-control input-sm','id' => 'dueDate','disabled' => 'disabled']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('driver',NULL,['class' => 'form-control input-sm','id' => 'driver','disabled' => 'disabled']) !!}

                                </div>
                            </div>

                            <div class="form-group">
                                {!! Form::label('Vehicle Registration', 'Vehicle Registration', array('class' => 'col-md-3 control-label')) !!}
                                <div class="col-md-6">
                                    {!! Form::text('vehicleReg',NULL,['class' => 'form-control input-sm','id' => 'vehicleReg','disabled' => 'disabled']) !!}

                                </div>
                            </div>

                            <div class="form-group">
                                {!! Form::label('Vehicle Purpose', 'Vehicle Purpose', array('class' => 'col-md-3 control-label')) !!}
                                <div class="col-md-6">
                                    {!! Form::text('vehiclePurpose',NULL,['class' => 'form-control input-sm','id' => 'vehiclePurpose','disabled' => 'disabled']) !!}
